...
#Date: 01-07-21
#Description: Generate relative abundance tables at each taxonomic level based on location and antibiotic.
...
for (z in 1:length(taxa)) {
  ...
  write.table(dFrame, file=paste0(output, taxa[z],"_Abundance_by_Location_Antibiotic.tsv"),sep = "\t", row.names = FALSE)
