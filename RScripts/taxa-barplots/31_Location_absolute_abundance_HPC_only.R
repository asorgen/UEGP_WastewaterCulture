...
ggsave(plot, file=paste0(output, taxa_input, "_absAbun_HPC_Location.pdf"),width = 20,height = 10)
...
ggsave(plot, file=paste0(output, taxa_input, "_absAbun_HPC_Location_inset.pdf"),width = 20,height = 10)
